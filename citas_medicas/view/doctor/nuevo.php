...
if (isset($_POST['agregar'])) {
	...
	try {
		...
		$stmt = $db->prepare("INSERT INTO doctor (1, nomdoc,apedoc,codespe,sexo,telefo,fechanaci,correo ,estado) VALUES (:dnidoc, :nomdoc, :apedoc, :codespe, :sexo,:telefo,:fechanaci,:correo,:estado)");
